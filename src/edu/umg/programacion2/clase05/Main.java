...
/**
 * Clase 5 - CRUD completo de estudiantes contra MySQL, SIN Maven.
 *
 * IMPORTANTE: este proyecto no usa ninguna herramienta de build (Maven, Gradle).
 * El driver de MySQL esta descargado a mano en lib/ y se referencia con -cp al
 * compilar y ejecutar. La logica de negocio (Estudiante, EstudianteDAO, este
 * menu) es identica a la del proyecto clase05-jdbc-con-maven: lo unico que
 * cambia entre ambos proyectos es como llega el driver al classpath.
 *
...
public class Main {
    ...
    private static void agregarEstudiante() {
        ...
        try {
            int id = estudianteDAO.crear(new Estudiante(nombre, carnet, activo));
